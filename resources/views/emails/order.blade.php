                                                    ...
                                                    <td class="text-12 c-grey l-grey a-right py-20"
                                                        ...
                                                        <a href="#" target="_blank" class="link c-grey"
                                                            style="text-decoration:none; color:#6e6e6e;"><span
                                                                class="link c-grey"
                                                                style="text-decoration:none; color:#6e6e6e;"></span></a>
                                                    </td>
                                                </tr>
                                            </table> <!-- END Top -->
                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="fluid-img img-center pb-50"
                                                                                                        ...
                                                                                                        <img src="{{ asset('images/illustrations/sketchy-1/2.png') }}"
                                                                                                            width="185"
                                                                                                            height="185"
                                                                                                            border="0"
                                                                                                            alt="Logo" />
                                                                                                                ...
                                                                                                                <td class="btn-20 btn-secondary c-white l-white"
                                                                                                                    ...
                                                                                                                    <a href="#"
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            ...
                                                                                                                            ORDEN:
                                                                                                                            {{ str_pad($order->id, 3, '0', STR_PAD_LEFT) }}</span>
                                                                                                                    </a>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <th class="column-top"
                                                                                                                        ...
                                                                                                                        <div class="fluid-img"
                                                                                                                            ...
                                                                                                                            <a href="#"
                                                                                                                                target="_blank">
                                                                                                                                <img src="{{ asset('storage/products/' . $cart->product->img) }}"
                                                                                                                                    border="0"
                                                                                                                                    width="230"
                                                                                                                                    height="200"
                                                                                                                                    alt="" />
                                                                                                                                ...
                                                                                                                                <table
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td class="title-20 lh-30 a-right mt-left"
                                                                                                                                            style="font-size:20px; color:red; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 30px; text-align:right;">
                                                                                                                                        ...
                                                                                                                                        <td class="title-20 lh-30 mt-right"
                                                                                                                                            style="font-size:20px; color:red; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 30px;">
                                                                                                                                            S/{{ $order->discount }}
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td class="btn-20 btn-secondary c-white l-white"
                                                                                                                                            ...
                                                                                                                                            <a href="#"
                                                                                                                                                ...
                                                                                                                                                <span
                                                                                                                                                    class="link c-white"
                                                                                                                                                    style="text-decoration:none; color:#ffffff;">TOTAL:
                                                                                                                                                    S/{{ $order->total }}</span>
                                                                                                                                            </a>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                    ...
                                                                    Distribuidora Florentino S.R.L. - Florentino
                                                                    Ameghino
                                                                    <br />
                                                                    <a href="Teléfono: +51 924 457 100"
                                                                        target="_blank" class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;">
                                                                        <span class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">+51
                                                                            924 457 100</span>
                                                                    </a>
                                                                    <br />
                                                                    <a href="mailto:admin@dflorentino.com.ar"
                                                                        target="_blank" class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">>admin@dflorentino.com.ar</span></a>
                                                                    - <a href="https://www.dflorentino.com.ar"
                                                                        target="_blank" class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">www.dflorentino.com.ar</span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
