                                                            ...
                                                            <tr>
                                                                <td style="border-radius: 10px 10px 0 0;"
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0"
                                                                        cellpadding="0">
                                                                        <tr>
                                                                            <td class="img-center p-30 px-15" style="font-size:0pt;line-height:0pt;text-align:center;">
                                                                                <img src="{{ asset('images/mail/' . $img)  }}" width="500" heigth="500" style="width: 100%;">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- END Main -->
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                                                    ...
                                                                    Calle Alfredo Icaza 218, Urb. San Roque - Santiago de Surco
                                                                    <br />
                                                                    <a href="tel:+51913070858" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;">
                                                                        <span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">+51 913 070 858</span>
                                                                        </a>
                                                                    <br />
                                                                    <a href="mailto:informes@pasteleriamimi.com" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">informes@pasteleriamimi.com</span></a>
                                                                    - <a href="https://pasteleriamimi.com" target="_blank"
                                                                        class="link c-white"
                                                                        style="text-decoration:none; color:#ffffff;"><span
                                                                            class="link c-white"
                                                                            style="text-decoration:none; color:#ffffff;">https://pasteleriamimi.com</span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
