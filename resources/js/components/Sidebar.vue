<template>
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
        ...
        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
            <a href="#">
                <img alt="Logo" src="/images/logos/Logo Fiorentino Web.png" class="h-70px app-sidebar-logo-default" />
                <img alt="Logo" src="/images/logos/Logo Fiorentino.png" class="h-20px app-sidebar-logo-minimize" />
                <!-- <img alt="Logo" src="/images/logos/default-dark.svg" class="h-25px app-sidebar-logo-default" />
                <img alt="Logo" src="/images/logos/default-small.svg" class="h-20px app-sidebar-logo-minimize" /> -->
            </a>
        ...
        <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item">
                        <a class="menu-link" :href="route('dashboard')" :class="{ active: route().current('dashboard') }">
                    ...
                    <div v-if="$page.props.auth.roles[0] === 'admin'">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" :href="route('cities.index')"
                                :class="{ active: route().current('cities.*') }">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div v-if="$page.props.auth.roles[0] === 'admin'">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" :href="route('conditions.index')"
                                :class="{ active: route().current('conditions.*') }">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="menu-title">Condición de IVA</span>
                            </a>
                        </div>
                    </div>
                    <div v-if="$page.props.auth.roles[0] === 'admin'">
                    ...
                    <div v-if="$page.props.auth.roles[0] === 'admin'">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" :href="route('status.index')"
                                :class="{ active: route().current('status.*') }">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div
                        v-if="$page.props.auth.roles[0] === 'admin' || $page.props.auth.roles[0] === 'despacho' || $page.props.auth.roles[0] === 'ventas'">
                        <div class="menu-item">
                    ...
                    <div v-if="$page.props.auth.roles[0] === 'admin' || $page.props.auth.roles[0] === 'ventas'">
                        <div class="menu-item">
                            <a class="menu-link" :href="route('pos.index')"
                                :class="{ active: route().current('pos.index') }">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
