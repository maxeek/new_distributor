            ...
            <div class="card">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Localidades</span>
                    </h3>

                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        title="Click para registrar localidad">
                        <Link :href="route('cities.create')" class="btn btn-sm btn-light-primary">
                ...
                <div class="card-body py-3">
                    <div class="table-responsive">
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                <template v-for="city in cities.data" :key="city.id">
                                    <tr>
                                        <!-- <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- <div class="symbol symbol-45px me-5">
                                                    <img src="/images/avatars/300-1.jpg" alt="" />
                                                </div> -->
                                        ...
                                        >
                                            <div class="d-flex flex-stack mb-2">
                                                <span
                                                    class="text-muted me-2 fs-7 fw-semobold"
                                                >
                                                    50%
                                                </span>
                                            </div>
                                        ...
                                        >
                                            <span class="svg-icon svg-icon-3">
                                                <inline-svg
                                                    src="/images/icons/duotune/general/gen019.svg"
                                                />
                                            </span>
                                        </a> -->
                                        ...
                                        >
                                            <span class="svg-icon svg-icon-3">
                                            <inline-svg
                                                src="/images/icons/duotune/general/gen027.svg"
                                            />
                                            </span>
                                        </a> -->
