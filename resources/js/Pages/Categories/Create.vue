                        ...
                        <div class="card-body pt-5">
                            <form @submit.prevent="submit()" class="form">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid" :class="{ 'is-invalid': errors.name }" v-model="form.name" />
                                ...
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span class="required">Categoría principal</span>
                                    </label>

                                    <select class="form-control form-control-solid"
                                        :class="{ 'is-invalid': errors.category_id }" v-model="form.category_id">
                                ...
                                <div class="d-flex justify-content-end">
                                    <Link :href="route('categories.index')" data-kt-contacts-type="cancel"
